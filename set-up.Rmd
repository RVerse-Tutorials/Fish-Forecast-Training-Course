...
The following with walk you through installing R, RStudio, and GitHub Desktop.  Though the instructions are long, it hopefully will not take you long to get set up.  You will need admin access on your laptop.
...
You will need to fork (copy0 repositories from [RVerse-Tutorials](https://github.com/RVerse-Tutorials) for many of the labs. Please try to do this with a test repository that I have set up for you. 
